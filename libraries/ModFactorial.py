...
def profile():
    import cProfile
    cProfile.run('mod_factorial(1000000007, 1000000)')
    cProfile.run('ModFactorial(1000000007, 1000000).factorial(1000000)')
    cProfile.run('ModFactorial(1000000007).factorial(1000000)')
